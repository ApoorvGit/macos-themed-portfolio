            ...
            <div className="text-gray-800 space-y-3">
              {currentStep >= 0 && (
                <p className="font-semibold text-2xl">
                  {displayText[0]}
                  {currentStep === 0 && displayText[0].length < messages[0].length && (
              ...
              {currentStep >= 1 && (
                <p className="text-base leading-relaxed">
                  ...
                  {currentStep === 1 && displayText[1].length < messages[1].length && (
                    <span className="animate-pulse">|</span>
                  )}
                </p>
              )}
              ...
              {currentStep >= 2 && (
                <p className="text-sm text-gray-500 italic">
                  {displayText[2]}
                  {currentStep === 2 && displayText[2].length < messages[2].length && (
                    <span className="animate-pulse">|</span>
                  )}
                </p>
              )}
