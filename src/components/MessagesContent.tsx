...
export const MessagesContent: React.FC = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      // Get AI response
      const aiReplyText = await getAIReply(newMessage.text, conversationHistory);
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="px-4 py-3 bg-gray-100 flex items-center gap-3 cursor-pointer hover:bg-gray-200 transition-colors">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-sm font-semibold text-gray-900">Apoorv Mishra</h3>
              <p className="text-xs text-gray-600 truncate">
                {messages.length > 1 ? messages[messages.length - 1].text : 'Start a conversation'}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="px-6 py-3 border-b border-gray-200 bg-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-semibold text-gray-900">Apoorv Mishra</h3>
