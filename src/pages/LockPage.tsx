...
import { PasswordCat } from "../components/PasswordCat";
  ...
  return (
    <Wallpaper>
      <div className="w-full h-full flex flex-col text-white animate-fade-in">
        ...
        {/* Password Helper Cat */}
        {!showUnlock && <PasswordCat />}

        {/* Date and Time at Top */}
        <div className="text-center pt-16">
          <p className="text-2xl font-semibold tracking-wide drop-shadow-md mb-2">
            {formatDate(time)}
          </p>
          <h1 className="text-8xl font-semibold tracking-tight drop-shadow-lg">
            {formatTime(time)}
          </h1>
        </div>
        ...
        <div className="flex-1 flex items-end justify-center pb-32">
          ...
          >
            ...
            {!showUnlock ? (
              <>
                {/* Username */}
                <h2 className="text-2xl font-medium mb-3 drop-shadow-md">
                  Apoorv Mishra
                </h2>
                {/* Touch ID prompt */}
                <p className="text-sm font-light opacity-60 drop-shadow-md">
              ...
              >
                ...
                {error && (
                  <p
                    className="text-red-200 text-sm font-medium drop-shadow-md"
                    role="alert"
                  >
                    Incorrect password
                  </p>
