...
export const FinderIcon: React.FC<{ className?: string }> = ({ className = "w-full h-full" }) => (
  <img src={FinderSvg} alt="Finder" className={className} />
);

export const SafariIcon: React.FC<{ className?: string }> = ({ className = "w-full h-full" }) => (
  <img src={SafariSvg} alt="Safari" className={className} />
);

export const TerminalIcon: React.FC<{ className?: string }> = ({ className = "w-full h-full" }) => (
  <img src={TerminalSvg} alt="Terminal" className={className} />
);

export const PhotosIcon: React.FC<{ className?: string }> = ({ className = "w-full h-full" }) => (
  <img src={PhotosSvg} alt="Photos" className={className} />
);

export const MailIcon: React.FC<{ className?: string }> = ({ className = "w-full h-full" }) => (
  <img src={MailSvg} alt="Mail" className={className} />
);

export const NotesIcon: React.FC<{ className?: string }> = ({ className = "w-full h-full" }) => (
  <img src={NotesSvg} alt="Notes" className={className} />
);

export const FaceTimeIcon: React.FC<{ className?: string }> = ({ className = "w-full h-full" }) => (
  <img src={FaceTimeSvg} alt="FaceTime" className={className} />
);

export const MessagesIcon: React.FC<{ className?: string }> = ({ className = "w-full h-full" }) => (
  <img src={MessagesSvg} alt="Messages" className={className} />
);

export const SiriIcon: React.FC<{ className?: string }> = ({ className = "w-full h-full" }) => (
