...
const SkillsContent: React.FC = () => (
  <div className="bg-black text-green-400 p-4 rounded font-mono text-sm">
    ...
    <div className="space-y-2">
      ...
      <div>
        Backend: Java Spring Boot, Express.js, REST APIs, Python (Lambda,
        scripting)
      </div>
      ...
      <div>
        DevOps & Cloud: Terraform, CloudFormation, AWS, GitHub Actions, Jenkins,
        Spinnaker, Artifactory
      </div>
  ...
  <div className="prose max-w-none">
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <a
          href="mailto:apoorvmishra1000@gmail.com"
      ...
      <div className="flex items-center gap-3">
        ...
        <a
          href="https://linkedin.com/in/erapoorv"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-600 hover:underline"
        >
...
Backend • Frontend • Cloud • DevOps • AI/ML`,
      ...
      links: [
        {
          text: "apoorvmishra1000@gmail.com",
          url: "mailto:apoorvmishra1000@gmail.com",
        },
        { text: "github.com/apoorvgit", url: "https://github.com/apoorvgit" },
        {
          text: "linkedin.com/in/erapoorv",
          url: "https://linkedin.com/in/erapoorv",
        },
      ],
    },
    {
      ...
      <div className="w-full h-full flex flex-col">
        ...
        <div className="flex-1 relative overflow-hidden">
          ...
          <div className="absolute bottom-24 left-32 flex flex-col items-center gap-2 cursor-pointer hover:bg-white/10 rounded-lg p-2 transition-colors">
            <svg
              className="w-16 h-16 text-blue-300 drop-shadow-lg"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
