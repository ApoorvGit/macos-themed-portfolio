    ...
    <div className="flex h-full">
      ...
      <div className="window-titlebar w-[180px] bg-gradient-to-b from-[#f5f5f7] to-[#ebebed] border-r border-gray-300/50 flex flex-col backdrop-blur-xl relative">
        ...
        <div className="pt-12 pb-2 px-3">
          <div className="text-[11px] font-semibold text-gray-500 mb-2 px-2 tracking-wide">
            Favorites
          </div>
          <div className="space-y-px">
            ...
            >
              ...
              />
              <span
                className={`text-[13px] ${selectedSidebarItem === "airdrop" ? "font-medium" : ""}`}
              >
                AirDrop
              </span>
            </div>
            ...
            >
              ...
              />
              <span
                className={`text-[13px] ${selectedSidebarItem === "recents" ? "font-medium" : ""}`}
              >
                Recents
              </span>
            </div>
            ...
            >
              ...
              />
              <span
                className={`text-[13px] ${selectedSidebarItem === "applications" ? "font-medium" : ""}`}
              >
                Applications
              </span>
            </div>
            ...
            >
              <svg
                className="w-[18px] h-[18px] text-[#007AFF]"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <span
                className={`text-[13px] ${selectedSidebarItem === "downloads" ? "font-medium" : ""}`}
              >
                Downloads
              </span>
            </div>
              ...
              {projects.map((project, index) => (
                ...
                >
                  <div className="w-[35%] flex items-center gap-2.5">
                    <svg
                      className={`w-[20px] h-[20px] flex-shrink-0 ${selectedProject === index ? "text-white" : "text-[#007AFF]"}`}
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                    ...
                    <div className="min-w-0 flex-1">
                      <div
                        className={`truncate ${selectedProject === index ? "text-white font-normal" : "text-gray-900"}`}
                      >
                        {project.name}
                      </div>
                    </div>
                  ...
                  <div
                    className={`w-[20%] ${selectedProject === index ? "text-white/95" : "text-gray-600"}`}
                  >
                    {project.modified}
                  </div>
                  <div className="w-[45%]">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {projects[selectedProject].tags.map((tag, idx) => (
                      <span
                        key={idx}
                        className="px-2 py-1 bg-blue-50 text-blue-700 rounded text-[10px] font-medium border border-blue-100"
                      >
                        {tag}
                      </span>
                    ))}
