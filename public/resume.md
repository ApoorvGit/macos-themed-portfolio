...
# Software Development Engineer 2, Expedia Group

April 2025- Present

# Spinnaker Management Service:

o Developed a Java Spring Boot-based backend service to streamline Spinnaker management at scale.  
o Exposed an API for Backstage to mark pipelines read-only on app decommission  
o Contributed to additional utility APIs enabling seamless interaction between internal tools and Spinnaker.  
o Tech Stack: Java, Spring Boot, Spinnaker APIs

# - GitHub Enterprise Cloud Migration System (Multi-Lambda Architecture):
...
# Security & Infra Hardening via Global ACL:

o Replaced local Akamai CIDRs with a centralized Global Origin ACL across all AWS environments.  
o Centralized policy eliminated the need for frequent manual updates  
o Tech Stack: Terraform, AWS CloudFormation, Akamai SiteShield, Jenkins

# SWE Intern, McKinsey & Company

Jan 2023 - July 2023

- Drag-and-Drop Architecture to Code | Express JS, PostgreSQL with Prisma, Docker

o Contributed to an app where users can draw the architecture of a project by dragging and dropping tech stacks to create microservices and drawing connections between the services for network connectivity.  
o The application will generate custom boilerplates, docker files, and Kubernetes Manifest Files for the drawn project.  
o Built DB schema, OTP-based auth, Dockerfile generator, and zipping utility modules.  
o Tech Stack:

Clinical Trial Management System | React JS, Redux, HighCharts, Bootstrap

o Built a real-time analytics dashboard for one of Asia's largest pharma firms, driving decisions and saving millions
...
God's Eye (AI-Powered Smart Glasses for the Visually Impaired)

( Demo Video | GitHub | Website)

o Glasses with real-time environmental narration, facial recognition, text narration, and road sign detection for assisted navigation.  
Won 2 Lakh INR in IONathon 2022, Finalist in Smart India Hackathon (SIH) 2022, multiple college level hackathons

# ThaparTALKs.in (Exclusive Social Network for TIET)

Full-Fledged Social Networking web app for TIET family, (310 active users) Sign up only through Thapar ID  
Highly secure, Real-time chat, File Transfer up to 500 MB, Stickers in chat

# - LastSeen (Tracking System Using Facial Recognition)
